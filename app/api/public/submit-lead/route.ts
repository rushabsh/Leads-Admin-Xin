  ...
  try {
    ...
    const caseDetailsObj = {
      ...
      screeningCriteria: {
        ...
        rideshareSymptomsDetails: rideshareSymptomsDetails || '',
        rideshareSymptomsDate: rideshareSymptomsDate || '',
        rideshareDiagnosisTestDetails: rideshareDiagnosisTestDetails || '',
        rideshareDiagnosisTestDate: rideshareDiagnosisTestDate || '',
        rideshareTreatmentDetails: rideshareTreatmentDetails || '',
