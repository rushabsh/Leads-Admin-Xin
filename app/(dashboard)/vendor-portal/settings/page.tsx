    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-4 mb-4 dark:border-slate-850">
            <Contact className="h-5 w-5 text-primary" />
            <h3 className="text-md font-bold">Organization Profile</h3>
          </div>
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-xs font-semibold uppercase tracking-wider text-slate-400">Billing Email</label>
              <input
                type="email"
                required
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-primary/20 hover:bg-primary/95 transition-all"
            >
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
          <div className="flex items-center gap-2 border-b border-slate-100 pb-4 mb-4 dark:border-slate-850">
            ...
            <h3 className="text-md font-bold">Security Credentials</h3>
          </div>
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-500 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-500/20 hover:bg-indigo-600 transition-all"
            >
