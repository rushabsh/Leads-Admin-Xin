        ...
        <div className="space-y-6">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1 text-xs text-slate-400">Aggregate media buying cap</p>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                    <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Leads Generated</span>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                    <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Allocated Campaigns</span>
                        <div className="rounded-lg bg-indigo-500/10 p-2 text-indigo-500">
                            <Percent className="h-4 w-4" />
                        </div>
                    </div>
                    <div className="mt-4">
                        <h3 className="text-2xl font-bold">{vendorCampaigns.length}</h3>
                        <p className="mt-1 text-xs text-slate-400">Historical Allocated Campaigns</p>
                    </div>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
                    <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Total Campaigns </span>
                        <div className="rounded-lg bg-indigo-500/10 p-2 text-indigo-500">
                            <Percent className="h-4 w-4" />
                        </div>
                    </div>
                    <div className="mt-4">
                        ...
                        <p className="mt-1 text-xs text-slate-400">Total Campaigns Database</p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col gap-4 border-b border-slate-100 p-5 dark:border-slate-850 md:flex-row md:items-center">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-slate-200 bg-slate-50/50 py-2.5 pr-4 pl-10 text-sm outline-none transition-all placeholder:text-slate-400 focus:border-primary focus:bg-black dark:border-slate-800 dark:bg-slate-950 dark:focus:border-primary"
                        />
                    </div>
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="rounded-xl border border-slate-200 bg-[#020618] px-3 py-2.5 text-sm outline-none dark:border-slate-800 dark:bg-slate-950"
                        >
